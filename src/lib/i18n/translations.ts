...
export const translations: Record<"en" | "kn", TranslationKeys> = {
  en: {
    ...
    screenerTitle: "Find Schemes For You",
    screenerSubtitle: "Answer 4 quick questions to find welfare schemes you may qualify for",
    screenerFindSchemes: "Find My Schemes",
    screenerGenderQuestion: "What is your gender?",
    screenerGenderMale: "Male",
    screenerGenderFemale: "Female",
    screenerGenderOther: "Other",
    screenerAgeQuestion: "What is your age?",
    screenerAgeUnder18: "Under 18",
    screenerAge18to35: "18 - 35",
    screenerAge36to60: "36 - 60",
    screenerAgeOver60: "Over 60",
    screenerSituationQuestion: "What is your situation?",
    screenerSituationFarmer: "Farmer",
    screenerSituationStudent: "Student",
    screenerSituationWorker: "Worker / Labourer",
    screenerSituationEntrepreneur: "Entrepreneur / Self-employed",
    screenerSituationUnemployed: "Unemployed",
    screenerSituationOther: "Other",
    screenerCategoryQuestion: "What is your social category?",
    screenerCategoryGeneral: "General",
    screenerCategoryOBC: "OBC",
    screenerCategorySC: "SC",
    screenerCategoryST: "ST",
    screenerCategoryMinority: "Minority",
    screenerResultsTitle: "Schemes You May Qualify For",
    screenerLikely: "Likely Match",
    screenerPossible: "Possible Match",
    screenerCheck: "Worth Checking",
  ...
  kn: {
    ...
    // Screener / Profile Wizard
    screenerTitle: "ನಿಮಗಾಗಿ ಯೋಜನೆಗಳನ್ನು ಹುಡುಕಿ",
    screenerSubtitle: "ನೀವು ಅರ್ಹರಾಗಬಹುದಾದ ಕಲ್ಯಾಣ ಯೋಜನೆಗಳನ್ನು ಹುಡುಕಲು 4 ತ್ವರಿತ ಪ್ರಶ್ನೆಗಳಿಗೆ ಉತ್ತರಿಸಿ",
    screenerFindSchemes: "ನನ್ನ ಯೋಜನೆಗಳನ್ನು ಹುಡುಕಿ",
    screenerGenderQuestion: "ನಿಮ್ಮ ಲಿಂಗ ಯಾವುದು?",
    screenerGenderMale: "ಪುರುಷ",
    screenerGenderFemale: "ಮಹಿಳೆ",
    screenerGenderOther: "ಇತರೆ",
    screenerAgeQuestion: "ನಿಮ್ಮ ವಯಸ್ಸು ಎಷ್ಟು?",
    screenerAgeUnder18: "18 ಕ್ಕಿಂತ ಕಡಿಮೆ",
    screenerAge18to35: "18 - 35",
    screenerAge36to60: "36 - 60",
    screenerAgeOver60: "60 ಕ್ಕಿಂತ ಮೇಲೆ",
    screenerSituationQuestion: "ನಿಮ್ಮ ಸ್ಥಿತಿ ಏನು?",
    screenerSituationFarmer: "ರೈತ",
    screenerSituationStudent: "ವಿದ್ಯಾರ್ಥಿ",
    screenerSituationWorker: "ಕಾರ್ಮಿಕ / ಕೂಲಿ",
    screenerSituationEntrepreneur: "ಉದ್ಯಮಿ / ಸ್ವಯಂ ಉದ್ಯೋಗಿ",
    screenerSituationUnemployed: "ನಿರುದ್ಯೋಗಿ",
    screenerSituationOther: "ಇತರೆ",
    screenerCategoryQuestion: "ನಿಮ್ಮ ಸಾಮಾಜಿಕ ವರ್ಗ ಯಾವುದು?",
    screenerCategoryGeneral: "ಸಾಮಾನ್ಯ",
    screenerCategoryOBC: "OBC",
    screenerCategorySC: "SC",
    screenerCategoryST: "ST",
    screenerCategoryMinority: "ಅಲ್ಪಸಂಖ್ಯಾತ",
    screenerResultsTitle: "ನೀವು ಅರ್ಹರಾಗಬಹುದಾದ ಯೋಜನೆಗಳು",
    screenerLikely: "ಹೊಂದಾಣಿಕೆಯಾಗಬಹುದು",
    screenerPossible: "ಸಂಭಾವ್ಯ ಹೊಂದಾಣಿಕೆ",
    screenerCheck: "ಪರಿಶೀಲಿಸಲು ಯೋಗ್ಯ",
